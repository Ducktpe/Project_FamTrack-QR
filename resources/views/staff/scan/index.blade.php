...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .scanner-label::before, .scanner-label::after {
            content: '';
            flex: 1;
            height: 1px;
            background: var(--gray-200);
        ...
        @media (max-width: 900px) {
            ...
            .page-header { padding: 0 16px; gap: 10px; height: auto; min-height: 68px; top: 36px; }
            ...
            .back-btn { padding: 7px 11px; font-size: 11px; }
        ...
        @media (max-width: 640px) {
            ...
            /* Stack back-btn + badge vertically on very small headers */
            .header-right { gap: 8px; }
            .back-btn span { display: none; } /* hide text, keep icon */
            ...
            /* Info table: stack key/value on very small screens */
            .info-table td:first-child { width: auto; }

            /* Btn row stacks on mobile */
            .btn-row { flex-direction: column; }
            .btn { flex: none; width: 100%; }

            .page-footer { padding: 0 12px; height: auto; min-height: 48px; }
            .footer-center { display: none; }
            .footer-left { font-size: 10px; }
        }

        @media (max-width: 380px) {
            .page-body { padding: 12px 10px 24px; }
        ...
        @if($events->isEmpty())
            ...
            <div class="alert-no-event">
                ...
                <div>
                    ...
                    <div class="alert-no-event-text">There are currently no active events. Please wait for the Barangay Admin to activate a distribution event before scanning.</div>
                </div>
            </div>
...
<script>
    ...
    eventSelect?.addEventListener('change', function() {
        if (this.value) { startScanner(); } else { stopScanner(); }
    });
            ...
            <div class="result-inner success">
                ...
                <div class="result-body">
                    <table class="info-table">
                        ...
                        ${badges.length > 0 ? `<tr><td>Program Flags</td><td>${badges.join('')}</td></tr>` : ''}
                    </table>
                    <div class="btn-row">
