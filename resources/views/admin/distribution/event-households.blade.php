    ...
    <div style="display:flex; align-items:center; gap:20px; padding:12px 16px; background:#EAF0FA; border:1px solid #C7D9F3; border-radius:3px; margin-bottom:16px; flex-wrap:wrap;">
        ...
        <div style="margin-left:auto; display:flex; gap:8px; align-items:center;">
            <a href="{{ route(auth()->user()->role.'.distribution.events.export.xlsx', $event) }}"
               target="_blank"
               style="display:inline-flex;align-items:center;gap:6px;padding:7px 14px;background:#1B3F7A;color:#fff;border-radius:3px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;text-decoration:none;">
